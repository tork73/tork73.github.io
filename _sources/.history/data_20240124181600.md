# Filer til ulike oppgaver og eksempler
...
df = pd.read_csv(url) 
```
I noen tilfeller må du også spesifisere hva om skiller de ulike verdiene (komma, semikolon, \t, ... ) og hvilken tegnsetting som er brukt. I eksempel 7.13 i boken har vi for eksempel importert tall fra ssb.no ved å skrive:
...
* [fana.csv](https://tork73.github.io/Data_behandling/fana.csv)
...
* [reiser.csv](https://tork73.github.io/Data_behandling/reiser.csv)
...
* [verdensbefolkning.csv](https://tork73.github.io/Data_behandling/verdensbefolkning.csv)
