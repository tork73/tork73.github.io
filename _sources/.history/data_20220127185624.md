...
df = pd.read_csv(url) 
```
I noen tilfeller må du også spesifisere hvordan de ulike cwr er delt (komma, semikolin, \t, ... ) og hvilken tegnsetting som er brukt. I eksempel 7.13 i boken har vi for eksempel importert tall fra ssb.no ved å skrive:
